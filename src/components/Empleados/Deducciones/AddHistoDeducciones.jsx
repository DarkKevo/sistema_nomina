...
export default function AddHistorialDeducciones({ update }) {
  ...
  const deducciones = useQuery('deducciones', () => fetch('http://localhost:3000/ListarDeducciones').then((res) => res.json()));
                ...
                {deducciones.data.error
                  ...
                  : deducciones.data &&
                    deducciones.data.map((dedu) => (
                      <option key={dedu.iddeducciones} value={dedu.descripcion_deduccion}>
